        ...
        <p class="register-index-title">ユーザーの新規登録</p>
            ...
            <form action="http://localhost/pages/admin/register/confirm.php" method="post" id="userNewForm">
                <dl>
                    ...
                    <dd>
                        <input type="text" name="department" id="department" size="40" style="height:30px;" placeholder="部署を入力してください" value="<?php echo (htmlspecialchars($_POST['department'], ENT_QUOTES)); ?>" />
                        
                    </dd>

                    <dt class="register-index-content">役職</dt>
                    <dd>
                        <input type="text" name="position" id="position" size="40" style="height:30px;" placeholder="役職を入力してください" value="<?php echo (htmlspecialchars($_POST['position'], ENT_QUOTES)); ?>" />
                        
                    </dd>

                    <dt class="register-index-content">メールアドレス</dt>
                    <dd>
                        <input type="text" name="mail" id="mail" size="40" style="height:30px;" placeholder="メールアドレスを入力してください" value="<?php echo (htmlspecialchars($_POST['mail'], ENT_QUOTES)); ?>" />
                        
                    </dd>

                    <dt class="register-index-content">パスワード</dt>
                    <dd>
                        <input type="text" name="pass" id="pass" size="40" style="height:30px;" placeholder="パスワードを入力してください" value="<?php echo (htmlspecialchars($_POST['pass'], ENT_QUOTES)); ?>" />
